...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Food Bank Distribution Network";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Client";
process.env.TABLE_NAME = process.env.TABLE_NAME || "client_records";
'use strict';
